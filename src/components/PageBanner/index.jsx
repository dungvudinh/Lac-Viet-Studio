...
const BannerItem = ({ image, className, belongTo }) => {
  return (
    <div src={image} className={cx('hero-slide__item', `${className}`)} 
    style={{ padding:`${belongTo === 'home' ? '20rem 0' : '13rem 0'}`, backgroundImage:`url(https://cdn1.bambulab.com/home/banner/MO-A1-mini.jpg)` }}>
